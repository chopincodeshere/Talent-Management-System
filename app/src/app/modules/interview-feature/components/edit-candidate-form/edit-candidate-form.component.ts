...
@Component({
  ...
  styleUrls: ['./edit-candidate-form.component.css'],
})
export class EditCandidateFormComponent {
  ...
  getCandidateById(): any {
    this.candidateService.getCandidateById(this.data).subscribe(
      (response) => {
  ...
  submitForm(): void {
    ...
    this.candidateService.updateCandidate(formData, this.data).subscribe(
      (updatedCandidate) => {
